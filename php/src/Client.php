...
/**
 * Client for the Bitcoin Price API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://bitcoin.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/bitcoin';
    ...
    private const VALIDATION_RULES = [
        ...
        'hourly' => ['type' => 'boolean', 'required' => false]
    ];
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\BitcoinClient] {$message}\n";
        }
    }
}
