...
namespace APIVerve.API.BitcoinPrice
{
    ...
    /// <summary>
    /// Client for the BitcoinPrice API
    /// </summary>
    public class BitcoinPriceAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/bitcoin";
        ...
        {
            { "currency", new ValidationRule { Type = "string", Required = false } },
            { "hourly", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public BitcoinPriceAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BitcoinPriceAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BitcoinPriceAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, BitcoinPriceQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(BitcoinPriceQueryOptions options)
        {
        ...
        public ResponseObj Execute(BitcoinPriceQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(BitcoinPriceQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(BitcoinPriceQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(BitcoinPriceQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(BitcoinPriceQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(BitcoinPriceQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(BitcoinPriceQueryOptions options)
        {
