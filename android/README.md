...
```gradle
dependencies {
    implementation 'com.github.apiverve:bitcoin-api:1.1.14'
}
```
...
```java
import com.apiverve.bitcoin.BitcoinPriceAPIClient;
import com.apiverve.bitcoin.APIResponse;
import com.apiverve.bitcoin.APIException;

// Initialize the client
BitcoinPriceAPIClient client = new BitcoinPriceAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/bitcoin](https://docs.apiverve.com/ref/bitcoin)
...
- **Documentation:** [https://docs.apiverve.com/ref/bitcoin](https://docs.apiverve.com/ref/bitcoin)
- **Issues:** [GitHub Issues](https://github.com/apiverve/bitcoin-api/issues)
