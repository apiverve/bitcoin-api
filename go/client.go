// Package bitcoin provides a Go client for the Bitcoin Price API.
//
// For more information, visit: https://apiverve.com/marketplace/bitcoin?utm_source=go&utm_medium=readme
package bitcoin
...
const (
	baseURL        = "https://api.apiverve.com/v1/bitcoin"
	defaultTimeout = 30 * time.Second
)

// Client is the Bitcoin Price API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Bitcoin Price API client.
...
// Execute makes a request to the Bitcoin Price API with typed parameters.
//
...
//   - currency: string - The currency to get the price in
